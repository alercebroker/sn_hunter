                      ...
                      <v-card>
                        ...
                        <v-card-text>
                          ...
                          >
                            ...
                            <tbody>
                              <tr
                                v-for="(row, index) in table_avro_info"
                                v-bind:key="index"
                              >
                                <td>{{ row[0] }}</td>
                                <td>{{ row[1] }}</td>
              ...
              <v-layout row wrap class="justify-center">
                <v-flex xs12>
                  <v-tooltip bottom>
                    ...
                    <span
                      >Discovery Stamps are the first stamps retrieved for an
                      object.</span
                    >
                  </v-tooltip>
                </v-flex>
                ...
                <v-flex xs4 class="text-xs-center">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span
                      >Template is an template image of the same region of the
                ...
                <v-flex xs4 class="text-xs-center">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span
                      >Difference is the change between science and template
                      images.</span
                    >
                  </v-tooltip>
                </v-flex>
