...
export default new Vuex.Store({
  ...
  actions: {
    ...
    retrieveAlert(context, oid) {
      ...
      axios.post(ztf_url + "/get_detections", parameters).then(
        function(response) {
    ...
    retrieveCandidates(context, params) {
      ...
      var parameters = {
        ...
        query_parameters: {
          filters: { classearly: 19 },
          dates: { firstmjd: { min: last_mjd } }
        },
        sortBy: "pclassearly",
        total: nCandidates
      };
